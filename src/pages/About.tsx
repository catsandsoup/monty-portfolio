...
const skillCategories = [{
  ...
  skills: ["Visualization project lifecycle management", "Resource coordination and allocation", "Quality control implementation", "Timeline management and prioritization", "Workflow optimization"]
}, {
  title: "Technical Leadership",
  icon: <Code2 className="h-6 w-6 text-[#00a5ee]" />,
  skills: ["Technology evaluation and selection", "Software implementation and customization", "IT infrastructure planning and development", "Cross-platform integration", "Technical problem-solving"]
}, {
  title: "Business Strategy",
  icon: <ChartLine className="h-6 w-6 text-[#00a5ee]" />,
  skills: ["Competitive market analysis", "Service development and positioning", "Product innovation", "Strategic planning", "Brand management"]
}, {
  title: "Digital Technology",
  icon: <Code2 className="h-6 w-6 text-[#00a5ee]" />,
  skills: ["Architectural visualization software", "Web development", "3D modeling and rendering", "Virtual tour technology", "Web hosting and file management"]
}, {
  title: "Entrepreneurial Capabilities",
  icon: <Brain className="h-6 w-6 text-[#00a5ee]" />,
  skills: ["New service conceptualization", "Business opportunity identification", "Strategic pricing", "White-label solution development", "Business development"]
}, {
  title: "Operations Management",
  icon: <LayoutDashboard className="h-6 w-6 text-[#00a5ee]" />,
  skills: ["Process standardization", "Technology procurement", "Database management", "File system optimization", "Resource efficiency"]
}, {
  title: "Soft Skills",
  icon: <Users className="h-6 w-6 text-[#00a5ee]" />,
  skills: ["Self-directed learning", "Time management", "Multi-disciplinary adaptability", "Change management", "Client relationship management"]
}, {
  title: "Communication Skills",
  icon: <MessagesSquare className="h-6 w-6 text-[#00a5ee]" />,
  skills: ["Marketing content creation", "Technical documentation", "Client presentations", "Brand representation", "Networking"]
}];
        ...
        <div className="space-y-24">
          ...
          duration: 0.6
            ...
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">My Leadership Philosophy</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {ethosPrinciples.map((principle, index) => <motion.div key={principle.title} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
                  ...
                  <Card className="h-full backdrop-blur-xl bg-white/80 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                    <CardHeader>
                      ...
                      <div className="space-y-2">
                        {category.skills.map((skill, idx) => <div key={idx} className="flex items-start gap-3">
