...
const MetricCard = ({
  ...
  delay
    ...
    <Card className="relative overflow-hidden backdrop-blur-xl bg-white/90 border-0 shadow-lg p-8 hover:shadow-xl transition-all duration-300 rounded-3xl">
      <div className="mb-4">
        {icon}
      </div>
...
const KeyMetrics = () => {
  ...
  return <section className="px-6 py-[64px]">
