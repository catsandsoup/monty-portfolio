...
const Hero = () => {
  return <section className="relative w-full pt-32 pb-24 bg-gradient-to-b from-[#4CAF50]/5 to-white/90 backdrop-blur-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-8">
          ...
          duration: 0.8
            ...
            <a href="https://www.naturaheal.com.au" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#4CAF50] hover:text-[#8BC34A] transition-colors text-lg font-medium">
              <span className="text-xl">Visit NaturaHeal Pty Ltd</span>
          ...
          duration: 0.8,
          delay: 0.2
        }} className="col-span-1 md:col-span-4 flex justify-center md:justify-end">
