          ...
          >
            <div className="flex flex-col gap-8">
              <div className="space-y-4">
                <h1 className="text-6xl md:text-7xl font-semibold tracking-tight bg-gradient-to-r from-[#4CAF50] to-[#8BC34A] bg-clip-text text-transparent">
                  NaturaHeal
                </h1>
                <p className="text-2xl text-gray-900/80 font-medium leading-relaxed tracking-tight">
                  Business Transformation & Digital Innovation
                </p>
              </div>
              
              <p className="text-xl text-gray-600/90 max-w-3xl leading-relaxed tracking-normal">
                Led business transformation initiatives, implementing modern inventory management systems
