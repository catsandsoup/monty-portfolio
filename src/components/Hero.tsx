      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="mb-12"
          >
            <div className="w-40 h-40 mx-auto rounded-full overflow-hidden border-4 border-[#00a5ee]/20 shadow-[0_0_60px_-15px_rgba(0,165,238,0.3)] transition-transform hover:scale-105 duration-300">
              <img
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-7xl lg:text-8xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-gray-800 to-gray-600"
          >
          ...
          >
            <p className="text-xl md:text-2xl text-gray-600 font-light tracking-wide leading-relaxed">
              Product & Business Strategist crafting digital experiences that drive impact.<br/>
          ...
          >
            <Link
              ...
              className="group flex items-center gap-2 px-8 py-4 text-lg font-medium text-white bg-[#00a5ee] rounded-full hover:bg-[#0094d6] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              View My Work
