...
const EvolutionStage = ({
  ...
  isRight = false,
  delay = 0
}: EvolutionStageProps) => <motion.div initial={{
  opacity: 0,
  x: isRight ? 20 : -20
}} whileInView={{
  opacity: 1,
  ...
  return <>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-white to-gray-50/90">
        ...
        duration: 0.8
          ...
          <p className="text-xl text-gray-600/90 max-w-3xl mx-auto">Transformed a traditional architectural visualisation business into a technology-driven real estate solutions provider.</p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <EvolutionStage title="House of Manuela" description="Traditional architectural visualisation studio focused on static renderings and basic 3D modelling" />
            <EvolutionStage title="HomeVR" description="Innovative digital platform providing immersive VR experiences and comprehensive real estate visualisation solutions" isRight delay={0.3} />
          </div>
        </div>
      </section>
    </>;
