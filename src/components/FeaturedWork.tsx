                ...
                <CarouselItem key={card.title} className="pl-4 md:basis-1/2 lg:basis-1/2">
                  ...
                  >
                    <Link to={card.link} className="block h-full">
                      <div
                        className={`relative h-full p-10 rounded-2xl ${colors.gradients.primaryFade} ${glassMorphism.light.blur} border border-[${colors.primary.blue}]/10 transition-all duration-500 hover:shadow-xl hover:-translate-y-1`}
                      >
                        <motion.div 
                          whileHover="hover"
                          initial="rest"
